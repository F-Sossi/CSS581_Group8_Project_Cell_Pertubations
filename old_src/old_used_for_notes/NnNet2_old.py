...
class ComplexNet(nn.Module):
    def __init__(self, input_size, output_size):
        ...
        self.transformer_encoder_layer = nn.TransformerEncoderLayer(
            d_model=128,  # This should match the output size of layer5
            nhead=32,      # Number of attention heads
        ...
        # Second Transformer layer for fine-tuning
        self.transformer_encoder_layer2 = nn.TransformerEncoderLayer(
            d_model=32, nhead=16, dim_feedforward=256, dropout=0.1)
        self.transformer_encoder2 = nn.TransformerEncoder(self.transformer_encoder_layer2, num_layers=1)
    ...
    def forward(self, x):
        ...
        # Prepare data for Transformer layer (add batch dimension and transpose)
